 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.logo.expression.binary.impl.EqualsImpl#getLeftExpression <em>Left Expression</em>}</li>
 *   <li>{@link fr.inria.diverse.logo.expression.binary.impl.EqualsImpl#getRightExpression <em>Right Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EqualsImpl extends MinimalEObjectImpl.Container implements Equals {
	...
	protected EClass eStaticClass() {
		return BinaryPackage.Literals.EQUALS;
	}
	...
	public NotificationChain basicSetLeftExpression(Expression newLeftExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BinaryPackage.EQUALS__LEFT_EXPRESSION, oldLeftExpression, newLeftExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeftExpression != leftExpression) {
			...
			if (leftExpression != null)
				msgs = ((InternalEObject) leftExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - BinaryPackage.EQUALS__LEFT_EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, BinaryPackage.EQUALS__LEFT_EXPRESSION,
	...
	public NotificationChain basicSetRightExpression(Expression newRightExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BinaryPackage.EQUALS__RIGHT_EXPRESSION, oldRightExpression, newRightExpression);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRightExpression != rightExpression) {
			...
			if (rightExpression != null)
				msgs = ((InternalEObject) rightExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - BinaryPackage.EQUALS__RIGHT_EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, BinaryPackage.EQUALS__RIGHT_EXPRESSION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case BinaryPackage.EQUALS__LEFT_EXPRESSION:
			return basicSetLeftExpression(null, msgs);
		case BinaryPackage.EQUALS__RIGHT_EXPRESSION:
