 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.logo.expression.binary.impl.MinusImpl#getLeftExpression <em>Left Expression</em>}</li>
 *   <li>{@link fr.inria.diverse.logo.expression.binary.impl.MinusImpl#getRightExpression <em>Right Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MinusImpl extends MinimalEObjectImpl.Container implements Minus {
	/**
	...
	protected EClass eStaticClass() {
		return BinaryPackage.Literals.MINUS;
	}
	...
	public NotificationChain basicSetLeftExpression(Expression newLeftExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BinaryPackage.MINUS__LEFT_EXPRESSION, oldLeftExpression, newLeftExpression);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeftExpression != leftExpression) {
			...
			if (leftExpression != null)
				msgs = ((InternalEObject) leftExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - BinaryPackage.MINUS__LEFT_EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, BinaryPackage.MINUS__LEFT_EXPRESSION,
	...
	public NotificationChain basicSetRightExpression(Expression newRightExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					BinaryPackage.MINUS__RIGHT_EXPRESSION, oldRightExpression, newRightExpression);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRightExpression != rightExpression) {
			...
			if (rightExpression != null)
				msgs = ((InternalEObject) rightExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - BinaryPackage.MINUS__RIGHT_EXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, BinaryPackage.MINUS__RIGHT_EXPRESSION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case BinaryPackage.MINUS__LEFT_EXPRESSION:
			return basicSetLeftExpression(null, msgs);
		case BinaryPackage.MINUS__RIGHT_EXPRESSION:
