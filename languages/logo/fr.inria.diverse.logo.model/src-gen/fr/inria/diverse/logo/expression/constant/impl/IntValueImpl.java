 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.logo.expression.constant.impl.IntValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntValueImpl extends MinimalEObjectImpl.Container implements IntValue {
	...
	protected EClass eStaticClass() {
		return ConstantPackage.Literals.INT_VALUE;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConstantPackage.INT_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ConstantPackage.INT_VALUE__VALUE:
			return getValue();
		}
