/**
 */
package fr.inria.diverse.logo.expression.constant.util;
...
public class ConstantAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ConstantSwitch<Adapter> modelSwitch = new ConstantSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.inria.diverse.logo.expression.constant.IntValue <em>Int Value</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.inria.diverse.logo.expression.constant.BoolValue <em>Bool Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
