 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.logo.expression.extended.impl.AndImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AndImpl extends MinimalEObjectImpl.Container implements And {
	...
	protected EClass eStaticClass() {
		return ExtendedPackage.Literals.AND;
	}
	...
	public EList<Expression> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList<Expression>(Expression.class, this,
					ExtendedPackage.AND__EXPRESSIONS);
		}
		return expressions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ExtendedPackage.AND__EXPRESSIONS:
