 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.logo.expression.extended.impl.OrImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrImpl extends MinimalEObjectImpl.Container implements Or {
	...
	protected EClass eStaticClass() {
		return ExtendedPackage.Literals.OR;
	}
	...
	public EList<Expression> getExpressions() {
		if (expressions == null) {
			expressions = new EObjectContainmentEList<Expression>(Expression.class, this,
					ExtendedPackage.OR__EXPRESSIONS);
		}
		return expressions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ExtendedPackage.OR__EXPRESSIONS:
