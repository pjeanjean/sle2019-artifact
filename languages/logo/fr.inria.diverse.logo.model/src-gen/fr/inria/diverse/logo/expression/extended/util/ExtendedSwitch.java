/**
 */
package fr.inria.diverse.logo.expression.extended.util;
 ...
 * <!-- end-user-doc -->
 * @see fr.inria.diverse.logo.expression.extended.ExtendedPackage
 * @generated
 */
public class ExtendedSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ExtendedPackage.AND: {
			...
			if (result == null)
				result = caseExtendedExpression(and);
			if (result == null)
		...
		case ExtendedPackage.OR: {
			...
			T result = caseOr(or);
			if (result == null)
				result = caseExtendedExpression(or);
			if (result == null)
