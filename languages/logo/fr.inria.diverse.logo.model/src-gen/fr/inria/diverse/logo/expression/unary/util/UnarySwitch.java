/**
 */
package fr.inria.diverse.logo.expression.unary.util;
 ...
 * @generated
 */
public class UnarySwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static UnaryPackage modelPackage;
	...
	public UnarySwitch() {
		if (modelPackage == null) {
			modelPackage = UnaryPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case UnaryPackage.OPPOSITE: {
			...
			if (result == null)
				result = caseUnaryExpression(opposite);
			if (result == null)
				result = caseExpression(opposite);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
