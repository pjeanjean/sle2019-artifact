...
public class ExpressionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ExpressionPackage.CONSTANT: {
		...
		case ExpressionPackage.EXTENDED_EXPRESSION: {
			ExtendedExpression extendedExpression = (ExtendedExpression) theEObject;
			T result = caseExtendedExpression(extendedExpression);
			if (result == null)
				result = caseExpression(extendedExpression);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ExpressionPackage.VARIABLE_READ: {
			VariableRead variableRead = (VariableRead) theEObject;
			T result = caseVariableRead(variableRead);
			if (result == null)
				result = caseExpression(variableRead);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Variable Read</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Variable Read</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVariableRead(VariableRead object) {
		return null;
	}
