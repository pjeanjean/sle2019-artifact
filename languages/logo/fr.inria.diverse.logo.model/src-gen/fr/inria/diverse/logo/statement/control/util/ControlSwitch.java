/**
 */
package fr.inria.diverse.logo.statement.control.util;
 ...
 * <!-- end-user-doc -->
 * @see fr.inria.diverse.logo.statement.control.ControlPackage
 * @generated
 */
public class ControlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ControlPackage.IF: {
			...
			T result = caseIf(if_);
			if (result == null)
				result = caseControlStatement(if_);
			if (result == null)
		...
		case ControlPackage.WHILE: {
			...
			if (result == null)
				result = caseControlStatement(while_);
			if (result == null)
		...
		case ControlPackage.REPEAT: {
			...
			if (result == null)
				result = caseControlStatement(repeat);
			if (result == null)
				result = caseStatement(repeat);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
