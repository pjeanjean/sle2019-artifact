 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.logo.statement.impl.RightImpl#getAngle <em>Angle</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RightImpl extends MinimalEObjectImpl.Container implements Right {
	...
	protected EClass eStaticClass() {
		return StatementPackage.Literals.RIGHT;
	}
	...
	public NotificationChain basicSetAngle(Expression newAngle, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					StatementPackage.RIGHT__ANGLE, oldAngle, newAngle);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newAngle != angle) {
			...
			if (angle != null)
				msgs = ((InternalEObject) angle).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - StatementPackage.RIGHT__ANGLE, null, msgs);
			if (newAngle != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StatementPackage.RIGHT__ANGLE, newAngle, newAngle));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case StatementPackage.RIGHT__ANGLE:
