 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.logo.value.impl.IntValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntValueImpl extends MinimalEObjectImpl.Container implements IntValue {
	...
	protected EClass eStaticClass() {
		return ValuePackage.Literals.INT_VALUE;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ValuePackage.INT_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ValuePackage.INT_VALUE__VALUE:
			return getValue();
		}
