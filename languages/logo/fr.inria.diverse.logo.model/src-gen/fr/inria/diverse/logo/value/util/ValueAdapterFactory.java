/**
 */
package fr.inria.diverse.logo.value.util;
...
public class ValueAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ValueSwitch<Adapter> modelSwitch = new ValueSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.inria.diverse.logo.value.IntValue <em>Int Value</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.inria.diverse.logo.value.BoolValue <em>Bool Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.inria.diverse.logo.Value <em>Value</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
